...
The *phytools* R library now contains a wide range of different methods and models for the analysis of *discrete character evolution* on trees. For example, *phytools* can be used to fit and plot an extended M*k* model (Lewis, 2001; Harmon, 2018), it can fit Pagel's correlational binary trait evolution model (Pagel, 1994), it can reconstruct ancestral states under the M*k* and the threshold models (Felsentsein, 2005, 2012; Revell, 2014), and it can compare the rate of discrete character evolution between clades and between trees (Revell et al., 2018; Revell and Harmon, 2022).

In this section, I'll discuss just a different discrete character evolution methods that are implemented in the *phytools* package.
