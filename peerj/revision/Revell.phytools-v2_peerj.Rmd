...
options(scipen=6)
```
```{r fig21-vert-phylomorphospace,fig.cap="Phylomorphospace of body mass and litter size for a selection of vertebrate species. The uderlying phylogenetic tree was obtained from Hedges et al. (2006). See main text for additional details.",fig.height=3.5, out.width = "100%"}
par(mar=c(5.1,4.1,0.6,2.1))
