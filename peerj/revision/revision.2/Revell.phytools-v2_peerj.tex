...
\NormalTok{ave\_butterfly.ltt}\OtherTok{\textless{}{-}}\FunctionTok{plot}\NormalTok{(butterfly.ltt,}\AttributeTok{show.total=}\ConstantTok{FALSE}\NormalTok{,}
  \AttributeTok{bty=}\StringTok{"n"}\NormalTok{,}\AttributeTok{las=}\DecValTok{1}\NormalTok{,}\AttributeTok{cex.axis=}\FloatTok{0.7}\NormalTok{,}\AttributeTok{cex.lab=}\FloatTok{0.8}\NormalTok{,}\AttributeTok{colors=}\NormalTok{hab.cols,}
  \AttributeTok{legend=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{1.05}\SpecialCharTok{*}\FunctionTok{max}\NormalTok{(}\FunctionTok{nodeHeights}\NormalTok{(butterfly.tree))))}
\NormalTok{k}\OtherTok{\textless{}{-}}\FunctionTok{length}\NormalTok{(}\FunctionTok{levels}\NormalTok{(butterfly.habitat))}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{,}\FunctionTok{paste}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{k,}\StringTok{". "}\NormalTok{,}\FunctionTok{levels}\NormalTok{(butterfly.habitat),}\AttributeTok{sep=}\StringTok{""}\NormalTok{),}
  \AttributeTok{bty=}\StringTok{"n"}\NormalTok{,}\AttributeTok{pch=}\DecValTok{22}\NormalTok{,}\AttributeTok{pt.bg=}\NormalTok{hab.cols,}\AttributeTok{pt.cex=}\FloatTok{1.2}\NormalTok{,}\AttributeTok{cex=}\FloatTok{0.7}\NormalTok{)}
\NormalTok{nn}\OtherTok{\textless{}{-}}\FunctionTok{length}\NormalTok{(ave\_butterfly.ltt}\SpecialCharTok{$}\NormalTok{times)}
\FunctionTok{text}\NormalTok{(}\AttributeTok{x=}\FunctionTok{rep}\NormalTok{(ave\_butterfly.ltt}\SpecialCharTok{$}\NormalTok{times[nn],k),}
  \AttributeTok{y=}\NormalTok{ave\_butterfly.ltt}\SpecialCharTok{$}\NormalTok{ltt[nn,}\DecValTok{1}\SpecialCharTok{:}\NormalTok{k],}
  \AttributeTok{labels=}\FunctionTok{paste}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{k,}\StringTok{"."}\NormalTok{,}\AttributeTok{sep=}\StringTok{""}\NormalTok{),}\AttributeTok{pos=}\DecValTok{4}\NormalTok{,}\AttributeTok{cex=}\FloatTok{0.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
